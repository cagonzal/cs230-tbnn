...
plt.savefig(f'figs/channel/loss1_{seed_no}.png', bbox_inches='tight')
...
plt.savefig(f'figs/channel/tbnn1_log_{seed_no}.png', bbox_inches='tight')
...
plt.savefig(f'figs/channel/tbnn1_linear_{seed_no}.png', bbox_inches='tight')
