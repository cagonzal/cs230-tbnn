...
# Filenames
filepath_mean = 'data/couette/re0220/LM_Couette_R0220_100PI_mean_prof.dat'
filepath_fluc = 'data/couette/re0220/LM_Couette_R0220_100PI_vel_fluc_prof.dat'
filepath_tke  = 'data/couette/re0220/LM_Couette_R0220_100PI_RSTE_k_prof.dat'

filepath_mean_test = 'data/couette/re0500/LM_Couette_R0500_100PI_mean_prof.dat'
filepath_fluc_test = 'data/couette/re0500/LM_Couette_R0500_100PI_vel_fluc_prof.dat'
filepath_tke_test  = 'data/couette/re0500/LM_Couette_R0500_100PI_RSTE_k_prof.dat'
...
plt.savefig(f'figs/couette/loss4_{seed_no}.png', bbox_inches='tight')
...
plt.savefig(f'figs/couette/tbnn4_log_{seed_no}.png', bbox_inches='tight')
...
plt.xlabel(r'$y$')
plt.legend(loc='upper right')
plt.savefig(f'figs/couette/tbnn4_linear_{seed_no}.png', bbox_inches='tight')
