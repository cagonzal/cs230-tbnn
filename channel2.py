...
# Train network
print("")
print("Training TBNN on baseline Re_tau=1000 channel data...")
...
print("")
print("Applying trained TBNN on baseline Re_tau=1000 channel data...")
...
plt.semilogx(y_raw * Re, bij_raw[:,0,1],'-',label='truth')
plt.ylabel(r'$b_{uv}$')
plt.xlabel(r'$y^+$')
